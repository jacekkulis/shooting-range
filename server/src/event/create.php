...
use firebase\PhpFirebaseCloudMessaging\NotificationSender;
...
<div class="col-sm-12 col-sm-offset-1 col-md-12 col-md-offset-2 main">
    <h1 class="page-header">Create competition</h1>
    <div class="container-fluid">
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data"
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="title" id="title">Competition title</label>
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="description" id="description">Competition
                    description</label>
                <div class="col-md-6 placeholder input-group">
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="mainReferees">Main referee</label>
                <div class="col-md-6 placeholder input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <select required class="form-control input-lg" name="mainRefereeSelectBox">
                        <?php
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="rater">Rater</label>
                <div class="col-md-6 placeholder input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <select required class="form-control input-lg" name="ratersSelectBox">
                        <?php
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="typeOfCompetition">Type of competition</label>
                <div class="col-md-6 placeholder input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-menu-hamburger"></i></span>
                    <select required class="form-control input-lg" name="typeOfCompetitionBox">
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="date">Date</label>
                <div class="col-md-6 placeholder input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                    <input class="form-control input-lg" type="datetime-local" name="date" required="required"
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="price" id="price">Price</label>
                <div class="col-md-6 placeholder input-group">
            ...
            <div class="form-group">
                <label class="control-label col-md-2 input-lg" for="thumbnail" id="thumbnail">Thumbnail</label>
                <div class="col-md-6">
                        ...
                        <span class="input-group-btn">
                            ...
                            <!-- image-preview-input -->
                                <div class="btn btn-default image-preview-input">
                                    ...
                                    <input type="file" required="true" accept="image/png, image/jpeg, image/gif"
                                           name="thumbnail"/> <!-- rename it -->
                                </div>
                        </span>
...
if (isset($_POST['create'])) {
    ...
    try {
        $db_connect->createEvent($mainRefereeId, $title, $description, $price, $raterId, $typeOfCompetitionId, $competitionDate, $thumbnailUrl);

        $notification_sender = new NotificationSender();
        $response = $notification_sender->sendNotification('New event!', "A new event " . $title . " has arrived.");

        $_SESSION['success'] = "Event has been created successfully!";
        echo "<meta http-equiv='refresh' content='0'>";
    } catch (Exception $e) {
